...
contract SwapperV2_2 {
    ...
    // 1) update with this (Swap to the most exact price) => https://github.com/Uniswap/v2-periphery/blob/master/contracts/examples/ExampleSwapToPrice.sol
    ...
    function swap(
        ...
        uint256[] memory _amountOutMin = IRouter(router).getAmountsOut(
            _amountIn,
            path
        );
